        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 my-6">
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200/70">
              ...
              <div className="text-xs font-medium text-google-green mt-0.5">~38 nuove recensioni</div>
            </div>
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200/70">
              ...
              <div className="text-xs font-medium text-google-green mt-0.5">~26 nuove recensioni</div>
            </div>
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200/70">
              ...
              <div className="text-xs font-medium text-google-green mt-0.5">~12 nuove recensioni</div>
            </div>
          </div>
