			...
			<section className="container mx-auto px-6 -mt-10 mb-20 relative z-20">
				<div className="bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900/40 rounded-3xl border border-white/10 p-8 md:p-16 backdrop-blur-xl shadow-2xl overflow-hidden relative group">
					...
					<div className="flex flex-col items-center relative z-10 w-full">
						<div className="w-full max-w-2xl bg-black/20 rounded-xl p-6 border border-white/5 flex flex-col items-center justify-center text-center">
							<div ref={calRef} className="min-h-[50px] w-full flex justify-center items-center overflow-visible"></div>
						</div>
					...
					<div className="grid md:grid-cols-2 gap-12 p-10 md:p-16 relative z-10">
						...
						<div className="flex flex-col justify-center space-y-8 bg-white/5 p-8 rounded-xl backdrop-blur-sm border border-white/5">
							...
							<ol className="space-y-6 relative border-l border-gray-700 ml-3">
								...
								<li className="ml-6 h-0">
									<span className="absolute -left-1.5 flex h-3 w-3 items-center justify-center rounded-full bg-green-500 ring-4 ring-gray-900"></span>
								</li>
							</ol>
							<div className="pt-4">
				...
				<div className="flex flex-col md:flex-row gap-16">
					...
					<div className="md:w-1/2 bg-gray-900/50 p-8 rounded-xl border border-white/5">
						...
						<ul className="space-y-4">
							<li className="flex items-center gap-4">
								<div className="flex bg-green-500/10 h-10 w-10 shrink-0 items-center justify-center rounded-lg text-green-400 text-xl leading-none pt-1">🚀</div>
								<div>
							...
							<li className="flex items-center gap-4">
								<div className="flex bg-blue-500/10 h-10 w-10 shrink-0 items-center justify-center rounded-lg text-blue-400 text-xl leading-none pt-1">🔧</div>
								<div>
