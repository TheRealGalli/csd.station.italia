...
// Simple Icons components for placeholder logos (or text fallback)
const GoogleLogo = () => (
	<svg className="h-6 w-auto opacity-70 hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
		<path d="M12.003 0C5.378 0 .003 5.376.003 12S5.378 24 12.003 24s12-5.376 12-12S18.628 0 12.003 0zm0 4a8 8 0 1 1 0 16 8 8 0 0 1 0-16z" />
		{/* Simplified placeholder path */}
		<text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fontSize="10" fill="currentColor">GCP</text>
	</svg>
);

const AzureLogo = () => (
	<svg className="h-6 w-auto opacity-70 hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
		<text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fontSize="8" fill="currentColor">AZURE</text>
	</svg>
);

const OpenAILogo = () => (
	<svg className="h-6 w-auto opacity-70 hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
		<text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fontSize="7" fill="currentColor">OPENAI</text>
	</svg>
);
	...
	return (
		<div className="flex flex-col gap-20 md:gap-32 pb-20">
			...
			<section className="relative flex flex-col items-center text-center pt-24 md:pt-32 gap-8 px-4">
				...
				<div ref={calRef} className="mt-4 min-h-[50px]"></div>
			</section>
			...
			<section className="border-y border-white/5 bg-white/[0.02] py-8">
				<div className="container mx-auto px-6 flex flex-col items-center gap-6">
					...
					<div className="flex flex-wrap justify-center gap-12 md:gap-20 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
						{/* Logos are simple text/svg placeholders for now */}
						<div className="flex items-center gap-2 text-gray-300 font-bold text-xl"><GoogleLogo /> Google Cloud</div>
						<div className="flex items-center gap-2 text-gray-300 font-bold text-xl"><AzureLogo /> Microsoft Azure</div>
						<div className="flex items-center gap-2 text-gray-300 font-bold text-xl"><OpenAILogo /> OpenAI</div>
					</div>
				</div>
			</section>
					...
					<div className="grid md:grid-cols-2 gap-12 p-10 md:p-16 relative z-10">
						...
						<div className="space-y-6">
							...
							<p className="text-gray-400 italic border-l-2 border-gray-700 pl-4">
								Il Compilatore Cognitivo ideato da Carlo Galli.
							</p>
							<div className="space-y-4 pt-4">
								<p className="text-gray-300">
									Costruito su <strong className="text-white">Google Vertex AI</strong> e potenziato da <strong className="text-white">Gemini 2.5 Flash</strong>, il DIE non è un semplice software. È un motore cognitivo che:
								</p>
								<ul className="space-y-3">
									{['Comprende semanticamente visure, contratti e documenti complessi.', 'Analizza input multimodali (Testo, Immagini, Audio).', 'Esegue verifiche incrociate (Cross-Check) tra documenti diversi.'].map(item => (
						...
						<ul className="space-y-4">
							...
							<li className="flex gap-4">
								...
								<div>
									...
									<span className="text-gray-500 text-sm">Nessun server fisico, solo logica pura.</span>
								</div>
							</li>
						</ul>
					</div>
